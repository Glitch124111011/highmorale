...
<br>
  ...
  <tbody >
    ...
    include 'db_connect.php';
            ...
            while($row1 = $result1->fetch_assoc()) {
                $id1 = $row1['user_id'];
                $sql="SELECT * FROM tbend_users WHERE user_id = '$id1'";
                $result = mysqli_query($db_connection, $sql);
                $row = mysqli_fetch_assoc($result);

                $id2 = $row1['reloading_id'];
          echo "<tr><td>" . $row["user_id"]. "</td><td>" . $row["firstname"]." ".$row["lastname"]. "</td><td>" . $row1["type"] . "</td><td>"
          . $row1["amount"]. "</td><td>".$row1["process_fee"]."</td><td>".$row1["conversion_fee"]."</td><td>".$row["balance"]."</td><td><a href='transac_approve.php?id=$id2'><input type='button' value='Approve'></a><a href='transac_reject.php?id=$id2'><input type='button' value='Reject'></a></tr>";
  ...
  <tbody >
    ...
    include 'db_connect.php';
            ...
            while($row1 = $result1->fetch_assoc()) {
                ...
                $id2 = $row1['reloading_id'];
          echo "<tr><td>" . $row1["user_id"]. "</td><td>" . $row["firstname"]." ".$row["lastname"]. "</td><td>" . $row1["amount"] . "</td><td>"
  ...
  <tbody >
    ...
    include 'db_connect.php';
            ...
            while($row1 = $result1->fetch_assoc()) {
                ...
                $id2 = $row1['reloading_id'];
          echo "<tr><td>" . $row1["user_id"]. "</td><td>" . $row["firstname"]." ".$row["lastname"]. "</td><td>"
  ...
  <tbody >
    ...
    $row = mysqli_fetch_assoc($result);
          ...
          echo "<tr><td>" . $row["user_id"]. "</td><td>" . $row["firstname"]." ".$row["lastname"]. "</td><td>".$row["balance"]."</td></tr>";
