            ...
            <div class="col-12">
                ...
                <?php echo "<a href='landing_page.php?id=$id2' class='logo'>" ?>
                    ...
                    <ul class="nav">
                      ...
                      <li><?php echo "<a href='profile.php?id=$id' class='active'>My Profile</a>" ?></li>
...
<input type="text" name="name" class="form-control" value="<?php echo $row['firstname']." ".$row['lastname'];?>">
</div>
</div>
<div class="row mb-3">
<div class="col-sm-3">
